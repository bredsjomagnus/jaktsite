...
<script>
	import { mdbProgress, mdbContainer, mdbBtn, mdbBtnGroup,mdbBtnToolbar, mdbIcon, mdbCard, mdbView, mdbCardBody, mdbCardText, mdbCardTitle, mdbCardImage, mdbMask, mdbCardFooter, mdbInput, mdbRow } from 'mdbvue';
	export default {
		name: 'ImageEdit',
		components: {
            mdbContainer,
